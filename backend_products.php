...
<div class="container">
    ...
    <a href="add_products.php" class="btn btn-success" id="add"><span class="glyphicon glyphicon-plus"></span> Add Product</a>
    <div class="row">
        ...
        <div class="scrollable table-responsive" id="no-more-tables">
            ...
            <table class="table table-bordered table-striped" style="margin-top:20px;">
                ...
                <tbody>
                    <?php
                    $file = simplexml_load_file('files/products_jer.xml');
 
                    foreach($file->product as $row){
                        ?>
                        <tr>
                            <td data-title="Product ID:"><?php echo $row->id; ?></td>
                            <td data-title="Picture:"><?php echo $row->picture; ?></td>
                            <td data-title="First Name:"><?php echo $row->productname; ?></td>
                            <td data-title="Quantity:"><?php echo $row->quantity; ?></td>
                            <td>
                                <a href="edit_products.php?id=<?php echo $row->id;?>"><button class="btn btn-sm btn-outline-secondary" type="button">Edit</button></a>
                                <a href="delete_products.php?id=<?php echo $row->id;?>" onclick="return confirm('Are you sure?')"><button class="btn btn-sm btn-outline-secondary" type="button" >Delete</button></a>
                            </td>
                        </tr>
                        <?php
                    }
