...
foreach ($xml->aisle as $aisle){
    ...
    echo '<div class="column">' . '<a href="product.php?aisle=' . $aisle->id . '&product=' . $product->id .'" style="color: #000000; text-decoration: none;">' . '<div class="card">' . '<img class="card-img-top" src="Images/'. $aisle->id . '/' .$product->image. '" alt="Card image" style="width:100%">' .
